    ...
    <section className="relative pt-0 md:pt-30 pb-10 overflow-hidden bg-white">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="col-span-1 lg:col-span-6 space-y-10">
            ...
            <form onSubmit={handleSearch}>
              <motion.div 
                ...
                className="flex items-center w-full max-w-lg border border-gray-100 shadow-sm bg-white overflow-hidden group focus-within:border-gray-300 transition-colors"
              >
                <div className="pl-5 text-gray-300 group-focus-within:text-gray-900 transition-colors">
                  <Search size={20} strokeWidth={1.5} />
                </div>
                <input 
                  type="text" 
                ...
                <button 
                  type="submit"
                  className="bg-gray-50 px-10 py-5 text-dynamic-body font-bold text-dark hover:bg-gray-900 hover:text-white transition-all border-l border-gray-100"
                >
                  Search
                </button>
              </motion.div>
          ...
          {/* Right Side: Image with Scale Reveal */}
          <motion.div 
          ...
          >
            <div className="relative w-full max-w-[650px]">
              ...
              <motion.div 
                ...
                className="absolute inset-0 bg-gray-50/50 rounded-full blur-3xl -z-10 transform scale-75" 
              />
              <img 
                src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=1000" 
                alt="Architectural Plan" 
